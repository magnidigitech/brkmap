...
export default function ScheduleTimeline({
  ...
  return (
    <div className="space-y-3 sm:space-y-4 relative">
      <div className="absolute left-4 sm:left-6 top-6 bottom-6 w-0.5 bg-gradient-to-b from-blue-400 via-indigo-400 to-purple-400 opacity-40 pointer-events-none" />
